...
## [2.0.0](https://github.com/googleapis/google-oauth-java-client/compare/v1.34.1...v2.0.0) (2022-10-08)


### ⚠ BREAKING CHANGES

* IdTokenVerifier now throws IOException if any issue obtaining public keys. Adding retries to public key fetch to cover transient network issues. (#934)
